...
android {
	...
	buildTypes {
		...
		create("enhanced") {
			// Custom build for enhanced home screen - can run alongside Play Store version
			applicationIdSuffix = ".enhanced"

			// Match with release variants from dependency modules
			...
			resValue("string", "app_name", "Jellyfin Enhanced")

			buildConfigField("boolean", "DEVELOPMENT", "false")
			buildConfigField("String", "GITHUB_REPO_OWNER", "\"crunchprank\"")
			buildConfigField("String", "GITHUB_REPO_NAME", "\"jellyfin-androidtv\"")

			// Disable minification to avoid Koin issues (APK will be larger but stable)
			isMinifyEnabled = false
			isShrinkResources = false

			// Use debug signing (auto-generated by Android SDK)
